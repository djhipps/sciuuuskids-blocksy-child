...
return array(
    ...
    'content'     => '<!-- wp:cover {"overlayColor":"custom-orange-overlay","customOverlayColor":"#ff7c00","dimRatio":50,"align":"full","className":"why-barefoot-section","style":{"spacing":{"padding":{"top":"100px","bottom":"60px","left":"20px","right":"20px"}},"color":{"background":"#ebf6ff"}}} -->
<div class="wp-block-cover alignfull why-barefoot-section has-custom-orange-overlay-background-color has-background-dim has-background" style="background-color:#ebf6ff;padding-top:100px;padding-right:20px;padding-bottom:60px;padding-left:20px"><span aria-hidden="true" class="wp-block-cover__background has-custom-orange-overlay-background-color has-background-dim" style="background-color:#ff7c00"></span><div class="wp-block-cover__inner-container">
    ...
    <!-- wp:heading {"textAlign":"center","level":2,"style":{"typography":{"fontSize":"42px","fontWeight":"700"},"color":{"text":"#000000"},"spacing":{"padding":{"top":"20px","bottom":"20px","left":"40px","right":"40px"},"margin":{"top":"0","bottom":"60px"}}}} -->
    <h2 class="wp-block-heading has-text-align-center has-text-color has-background" style="color:#000000;margin-top:0;margin-bottom:60px;padding-top:20px;padding-right:40px;padding-bottom:20px;padding-left:40px;font-size:42px;font-weight:700">Perchè barefoot?</h2>
    <!-- /wp:heading -->
