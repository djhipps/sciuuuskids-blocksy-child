...
return array(
    ...
    'content'     => '<!-- wp:cover {"url":"' . esc_url( get_stylesheet_directory_uri() ) . '/assets/images/home-page-pic-lira.webp","dimRatio":20,"overlayColor":"white","minHeight":75,"minHeightUnit":"vh","align":"full","className":"hero-section-bg hero-section-bg-lira","style":{"spacing":{"padding":{"top":"100px","bottom":"100px","left":"20px","right":"20px"}}}} -->
<div class="wp-block-cover alignfull hero-section-bg hero-section-bg-lira" style="padding-top:100px;padding-right:20px;padding-bottom:100px;padding-left:20px;min-height:75vh"><span aria-hidden="true" class="wp-block-cover__background has-white-background-color has-background-dim-20 has-background-dim"></span><img class="wp-block-cover__image-background hero-bg-image" alt="Scarpe barefoot per bambini" src="' . esc_url( get_stylesheet_directory_uri() ) . '/assets/images/home-page-pic-lira.webp" /><div class="wp-block-cover__inner-container">
